...
"""
	function solve_mc_doe_log_fairness(
		data::Union{Dict{String,<:Any},String},
		model_type::Type,
		solver;
		kwargs...
...
Solve DOE quantification problem with objective for mean absolute value differences 
"""
function solve_mc_doe_log_fairness(data::Union{Dict{String,<:Any},String},  solver; kwargs...)
    return _PMD.solve_mc_model(data, _PMD.IVRENPowerModel, solver, build_mc_doe_log_fairness; kwargs...)
end

"""
	function build_mc_doe_log_fairness(
		pm::AbstractExplicitNeutralIVRModel
	)

constructor for DOE quantification in current-voltage variable space with explicit neutrals
"""
function build_mc_doe_log_fairness(pm::_PMD.AbstractExplicitNeutralIVRModel)
